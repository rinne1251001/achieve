            ...
            <div class="faq_item">
                ...
                <div class="faq_answer">
                    <p>
                        ...
                        ・ゴール名をクリックすることでゴールの詳細ページに移動します。<br>
                        ・達成したタスクの欄では、×ボタンを押すことでゴールを非表示にできます。非表示にしたゴールはフィルターボタンから再表示できます。<br>
                        ・フィルターボタン左の矢印ボタンで昇順降順の変更ができます。<br>
                        ・フィルターボタン右のタブから達成したタスクの欄全体の表示変更ができます。<br>
                          このタブによる表示変更は×ボタンにより非表示にしたゴールには影響しません。
                    </p>
                </div>
            </div>
