...
<main>
    <div>
        ...
        <div id="input-bar" style="position: fixed; bottom: 0; left: 50%; transform: translateX(-50%); width: min(700px, 100% - 20px); padding: 10px 0 20px; background: linear-gradient(to bottom, transparent 0%, var(--bg-color) 30%); display: flex; align-items: flex-end; gap: 10px;">        
